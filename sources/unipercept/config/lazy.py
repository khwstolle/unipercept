...
def _maybe_show_config(path: str, cfg: DictConfig):
    if laco.get_env(bool, "UP_CONFIG_SHOW", default=False):
        logger.info(
...
def instantiate(cfg: T.Any, /) -> object:
    ...
    if laco.get_env(bool, "UP_CONFIG_TRACE", default=False):
        logger.info(
