...
from unipercept.tensors import DepthFormat, DepthTensor, PanopticFormat, PanopticTensor
...
class PseudoGenerator:
    ...
    def __init__(
        ...
        panoptic_format: PanopticFormat | str | None = None,
    ):
