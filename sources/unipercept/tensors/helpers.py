...
def multi_read(
    ...
    *,
    ...
    Example:
    ```python
    from unipercept.data.io import multi_read, load_panoptic_map
    ...
    panoptic_maps = multi_read(load_panoptic_map, key="panoptic")(sources, dataset_info)
    ```

    The result is a single tensor with shape `(2, H, W)` of type ``PanopticTensor``.
    """
