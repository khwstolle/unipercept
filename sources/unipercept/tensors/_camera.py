...
By convention, all spatial shapes are (H, W) and coordinates are (X, Y) where X is the
wide axis and Y is the tall axis.
"""
...
class PinholeCameraTensor(TVTensor):
    """
    ...
    def I(self) -> Tensor:
        ...
        """
        return self.get_intrinsics(self)
    ...
    def E(self) -> Tensor:
        ...
        """
        return self.get_extrinsics(self)
    ...
    def crop_bbox(self) -> Tensor:
        ...
        """
        return self.get_crop_bbox(self)
    ...
    def crop_size(self) -> Tensor:
        ...
        """
        return self.get_crop_size(self)
    ...
    def crop_height(self) -> Tensor:
        ...
        """
        return self.get_crop_size(self)[..., 0]
    ...
    def crop_width(self) -> Tensor:
        ...
        """
        return self.get_crop_size(self)[..., 1]
    ...
    def canvas_size(self) -> Tensor:
        ...
        """
        return self.get_canvas_size(self)
    ...
    def canvas_height(self) -> Tensor:
        ...
        """
        return self.get_canvas_size(self)[..., 0]
    ...
    def canvas_width(self) -> Tensor:
        ...
        """
        return self.get_canvas_size(self)[..., 1]

    @property
    # @_as_tensor
    def sensor_size(self) -> Tensor:
        return self.get_sensor_size(self)
    ...
    def focal_length(self) -> Tensor:
        ...
        """
        return self.get_focal_length(self)
    ...
    def principal_point(self) -> Tensor:
        ...
        """
        return self.get_principal_point(self)
    ...
    def translation(self) -> Tensor:
        ...
        """
        return self.get_translation(self)
    ...
    def K(self) -> Tensor:
        ...
        """
        return self.get_intrinsics(self)[..., :3, :3]
    ...
    def R(self) -> Tensor:
        ...
        """
        return self.get_extrinsics(self)[..., :3, :3]
    ...
    def Rt(self) -> Tensor:
        ...
        """
        return self.get_extrinsics(self)[..., :3, :]
    ...
    def __repr__(self, *args, **kwargs):
        ...
        self = self.detach().cpu().as_subclass(PinholeCameraTensor)
        TAB = " " * 2
        fields = f"\n{TAB}".join(
            f"{k}: {v}"
            for k, v in {
    ...
    ##############################################################
    # Functions to get parameters, returning Tensor w/o subclass #
    ##############################################################
    ...
    def get_crop_size(cam: Tensor) -> Tensor:
        return _flip_spatial(
            PinholeCameraTensor.get_crop_bbox(cam)[..., 2:]
            - PinholeCameraTensor.get_crop_bbox(cam)[..., :2]
        )
...
@register_kernel(functional="resize", tv_tensor_cls=PinholeCameraTensor)
def resize_camera(
    camera: PinholeCameraTensor,
    size: list[int],
    ...
    if camera.ndim >= 3:
        ...
        resized_cams = [
            resize_camera(
                cam.as_subclass(PinholeCameraTensor),
                size,
                interpolation,
                max_size,
                antialias,
    ...
    return camera.as_subclass(PinholeCameraTensor)


@register_kernel(functional="crop", tv_tensor_cls=PinholeCameraTensor)
def crop_camera(
    camera: PinholeCameraTensor,
    top: int,
    left: int,
...
# TODO: flip
@register_kernel(functional="horizontal_flip", tv_tensor_cls=PinholeCameraTensor)
def horizontal_flip_camera(
    camera: PinholeCameraTensor,
) -> Tensor:
    return camera.horizontal_flip().as_subclass(PinholeCameraTensor)


# TODO: pad
@register_kernel(functional="vertical_flip", tv_tensor_cls=PinholeCameraTensor)
def vertical_flip_camera(
    camera: PinholeCameraTensor,
) -> Tensor:
    return camera.vertial_flip().as_subclass(PinholeCameraTensor)
